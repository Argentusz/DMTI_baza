...
N-9 | Вычитание из натурального другого натурального, умноженного на цифру для случая с неотрицательным результатом | SUB_NDN_N | SUB_NN_N MultiplicationNaturalNumber Compare  | Комаровский
...
Z-6 | Сложение целых чисел | ADD_ZZ_Z | Positivity Absolute Compare ADD_NN_NSUB_NN_N MultiplicationByNegativeOne | Семёнов
